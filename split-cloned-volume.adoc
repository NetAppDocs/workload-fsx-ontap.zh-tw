...
* 若要分割複製的 Volume，必須關聯一個連結。link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["了解如何關聯現有連結或建立並關聯新連結"^]。連結關聯完成後，請返回此作業。
...
. 選取含有要分割之複製 Volume 的 Volume 動作選單。
