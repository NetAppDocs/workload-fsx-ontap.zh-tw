...
summary: 變更NetApp Workload Factory 中的分層策略，將資料從高效能主儲存層重新指派到二級容量池儲存層。 
---
= 在NetApp Workload Factory 中更改磁碟區的分層策略
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
在NetApp Workload Factory 中，您可以變更分層策略，以自動將資料從高效能主儲存層重新指派至二級容量池儲存層。
