...
summary: 了解如何管理 Volume 容量，包括手動調整 Volume 大小以及在 Workload Factory 中使用 Volume 自動擴充。 
---
= 在 NetApp Workload Factory 中管理 Volume 容量
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
Volume 容量應隨著需求變化進行調整。您可以手動調整 Volume 大小，或開啟 Volume 自動擴充，讓 Workload Factory 為您管理 Volume 容量。檢查 FlexVol 或 FlexGroup Volume 容量的平衡，並重新平衡 Volume 容量，將檔案均勻分散到節點中的所有 FlexVol Volume 或所有組成 Volume 上，以便所有節點都能參與單一 FlexGroup Volume 的工作負載。
...
啟用 Volume 自動擴充，即可讓 Workload Factory 為您管理 Volume 容量。您可以隨時停用此功能。


NOTE: iSCSI Volume 不支援 Volume 自動擴充。

.開始之前
若要啟用 Volume 自動擴充，您必須關聯連結。link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["了解如何關聯現有連結或建立並關聯新連結"^]。連結關聯完成後，請返回此操作。
...
.開始之前
若要調整 Volume 容量，您必須關聯連結。link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["了解如何關聯現有連結或建立並關聯新連結"^]。連結關聯後，請返回此操作。
...
== 重新平衡 FlexVol 和 FlexGroup Volume 的 Volume 容量
...
* 若要檢查 Volume 的平衡，您必須link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["建立並關聯連結或將現有連結關聯到檔案系統"^]。連結建立關聯後，請返回此作業。
...
* 若要重新平衡 Volume，您必須link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["建立並關聯連結或將現有連結關聯到檔案系統"^]。連結關聯後，返回此操作。
