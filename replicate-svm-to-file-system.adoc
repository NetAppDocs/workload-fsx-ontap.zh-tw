...
.開始之前
若要將儲存設備虛擬機器複寫到另一個 FSx for ONTAP 檔案系統，您必須關聯連結。link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["了解如何關聯現有連結或建立並關聯新連結"^]。連結關聯完成後，請返回此操作。
...
. 在「管理儲存虛擬機器」畫面上，選擇要為其複製 SVM 的儲存虛擬機器的操作選單，然後選擇「進階操作」>「複製儲存虛擬機器」。
