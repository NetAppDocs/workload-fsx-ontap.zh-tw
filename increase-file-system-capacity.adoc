...
---
= 在 NetApp Workload Factory 中手動調整檔案系統容量
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
當使用量超過您指定的臨界值時，增加 SSD 儲存容量。當您不使用工作集時，減少 SSD 儲存容量以節省成本。

或者，您可以 link:manage-capacity-automatically.html["啟用自動容量管理"] 讓 Workload Factory 為您管理檔案系統容量。
